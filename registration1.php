<?php
	...
	if (isset($_POST['register-submit'])) {
		...
		if ($userFName != preg_match("/^[a-zA-Z-' ]*$/",$userFName)){ $fNameError = "Only letters and white space are allowed!";}
		if ($userLName != preg_match("/^[a-zA-Z-' ]*$/",$userLName)){ $lNameError = "Only letters and white space are allowed!";}		
		//if ($userEmail != !filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ $emailError = "Email is invalid!";}
			...
			<fieldset class="registerMenu">
				...
				<form action="registration.php" method="post"><br/>
					...
					<div class="regContainer">
						...
						<input type="text" class="regBox" id="searchBar" minlength="2" placeholder="First Name..." name="userFName" size = "70"/>
					</div>					
					<a id="fNameError" style="color:red;"><?php echo $fNameError; ?></a><br/>	
					<label class="userLNameLabel"> Last Name:</label><br/>					
					<div class="regContainer">
						<i class="fas fa-user regIcon"></i>
						<input type="text" class="regBox" id="searchBar" minlength="2" placeholder="Last Name..." name="userLName" size = "70" />
					</div>
					...
					<div class="regContainer">
						...
						<input type="email" class="regBox" id="searchBar" placeholder="E-mail..." name="userEmail" size = "70"/>
					</div>
					...
					<div class="regContainer">
						...
						<input type="password" class="regBox" id="pwInput" minlength="15" placeholder="Password..." name="userPassword" size = "70"/>
					...
					<div class="regContainer">
						<i class="fas fa-key regIcon"></i>
						<input type="password" class="regBox" id="pwReInput" minlength="15" placeholder="Retype Password..." name="userRePassword" size = "70"/>
