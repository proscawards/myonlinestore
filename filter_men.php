<?php
	...
	if (isset($_POST['ColourPink'])) {	
		$sql = "SELECT * FROM item WHERE ITEM_SECTION = 'Men' AND ITEM_COLOUR LIKE 'Pink%' ";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
			while($row = mysqli_fetch_assoc($result)){
				$itemName = $row['ITEM_NAME'];
	...
	if (isset($_POST['CatPants'])) {	
		$sql = "SELECT * FROM item WHERE ITEM_SECTION = 'Men' AND ITEM_SUBSEC = 'Pants'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
			while($row = mysqli_fetch_assoc($result)){
				$itemName = $row['ITEM_NAME'];
	...
	if (isset($_POST['CatCloth'])) {	
		$sql = "SELECT * FROM item WHERE ITEM_SECTION = 'Men' AND ITEM_SUBSEC = 'Clothing'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
			while($row = mysqli_fetch_assoc($result)){
				$itemName = $row['ITEM_NAME'];
	...
	if (isset($_POST['CatShoes'])) {	
		$sql = "SELECT * FROM item WHERE ITEM_SECTION = 'Men' AND ITEM_SUBSEC = 'Shoes'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
			while($row = mysqli_fetch_assoc($result)){
				$itemName = $row['ITEM_NAME'];
	...
	if (isset($_POST['CatAcc'])) {	
		$sql = "SELECT * FROM item WHERE ITEM_SECTION = 'Men' AND ITEM_SUBSEC = 'Accessories'";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
			while($row = mysqli_fetch_assoc($result)){
				$itemName = $row['ITEM_NAME'];
